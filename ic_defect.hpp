...
void generateIC_defects(cosmology & cosmo, defects_metadata & defects_sim, const double fourpiG, DefectBase *defects, GlobalDefect  & defects_, double z_ic_defect,double z_in ,double dx, string h5filename,string filename_phi, string filename_pi)
{

	defects = &defects_; 

	defects_.generate_init_cond(filename_phi, filename_pi, h5filename);
